...
Traceback (most recent call last):
  File "/opt/lsst/software/stack/conda/miniconda3-py38_4.9.2/envs/lsst-scipipe-1.0.0/lib/python3.8/site-packages/lsst/ts/salobj/csc_utils.py", line 139, in set_summary_state
    state_data = await remote.evt_summaryState.aget(timeout=timeout)  # type: ignore
  File "/opt/lsst/software/stack/conda/miniconda3-py38_4.9.2/envs/lsst-scipipe-1.0.0/lib/python3.8/site-packages/lsst/ts/salobj/topics/read_topic.py", line 533, in aget
    await asyncio.wait_for(self._next_task, timeout=timeout)
  File "/opt/lsst/software/stack/conda/miniconda3-py38_4.9.2/envs/lsst-scipipe-1.0.0/lib/python3.8/asyncio/tasks.py", line 501, in wait_for
...
Traceback (most recent call last):
  File "/opt/lsst/software/stack/conda/miniconda3-py38_4.9.2/envs/lsst-scipipe-1.0.0/lib/python3.8/site-packages/lsst/ts/salobj/csc_utils.py", line 141, in set_summary_state
...
class ExceptionEndInformation:
    ...
    child: 'ExceptionInformation' = None
...
class ExceptionInformation:
    ...
    type: str = 'root'
    stacktrace: List[str] = field(default_factory = list)
    child: 'ExceptionInformation' = ExceptionEndInformation(stacktrace=[])
...
def get_exception(exceptions_text: List[str], exception_info: List[str]) -> int:
    ...
    if  line_text == "During handling of the above exception, another exception occurred:":
        return ExceptionRelation.SIDE_CAUSE
    elif line_text == "The above exception was the direct cause of the following exception:":
...
def set_hierarchy_exception(exceptions_text: List[str], parent_exception: ExceptionInformation, child_exception = False) -> None:
    """
    :param exceptions_text:
    ...
    if child_exception:
        exception_info = ExceptionInformation(type = raw_exception_info[-1], stacktrace=raw_exception_info[:], relation=child_relation)
    else:
        exception_info = ExceptionInformation(type=raw_exception_info[0], stacktrace=raw_exception_info[:], relation=child_relation)
