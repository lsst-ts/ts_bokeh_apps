...
from lsst.ts.bokeh.apps.examples.export import \
    initialize_app as initialize_examples
# from lsst.bokeh.apps.log_reader.export import initialize_app # noqa: E501 W505
# from lsst.bokeh.apps.plot_selector_r.export import initialize_app as initialize_react_plot_selector # noqa: E501 W505
from lsst.ts.bokeh.main.server_information import ServerInformation
from lsst.ts.library.utils.logger import get_logger, initialize_stream_logger
from tornado.ioloop import IOLoop
from tornado.web import StaticFileHandler

# from lsst.library.data_controller.efd.efd_data_controller import EFDDataController # noqa: E501 W505
# from lsst.library.data_controller.efd.simulated_data_controller import SimulatedDataController # noqa: E501 W505
...
def bk_worker(server_information: ServerInformation) -> None:
    ...
    print(os.path.normpath(os.path.join(os.path.dirname(__file__), "../../../bokeh/apps/examples")))
    print(
        ...
        (
            ...
            StaticFileHandler,
            {
                "path": os.path.normpath(
                    os.path.join(os.path.dirname(__file__), "../../../bokeh/apps/examples")
                )
            },
        ),
        (
            ...
            {
                "path": os.path.normpath(
                    os.path.join(os.path.dirname(__file__), "../../../bokeh/apps")
                )
            },
        ),
    ]
...
def bk_worker_gnunicorn(flask_information: ServerInformation) -> None:
    # This is not working yet
    pass


#     static_patterns = [(r'/(.*)', StaticFileHandler,
#     {'path': os.path.normpath(os.path.join(os.path.dirname(__file__),
#     "../apps"))})] #for file in flask_information.static_path
#     sockets, port = bind_sockets("localhost", 0)
#     print(port)
#     asyncio.set_event_loop(asyncio.new_event_loop())
#
#     print(flask_information.applications)
#     bokeh_tornado = BokehTornado(flask_information.applications,
...
class Configuration:
    ...
    def get_bokeh_connection(self) -> str:
        return str(self._configuration["bokeh_host"])

    def get_bokeh_port(self) -> int:
        return int(self._configuration["bokeh_port"])

    def get_flask_connection(self) -> str:
        return str(self._configuration["flask_host"])
...
if __name__ == "__main__":
    ...
    # Host where server will be running,
