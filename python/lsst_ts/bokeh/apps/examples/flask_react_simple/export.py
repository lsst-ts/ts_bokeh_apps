...
def initialize_app(server_information: ServerInformation) -> ServerInformation:
    flask_react_simple_blueprint = Blueprint('flask_react_simple_blueprint', __name__,
                                             url_prefix="/examples/flask_react_simple",
                                             static_folder="flask_react_simple_app/build/static",
                                             static_url_path="/flask_react_simple_app/build/static")

    @flask_react_simple_blueprint.route("/", methods=['GET'])  # type: ignore
