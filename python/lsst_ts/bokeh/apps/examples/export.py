...
from lsst_ts.bokeh.apps.examples.bokeh_raw.export import \
...
from lsst_ts.bokeh.apps.examples.flask_raw.export import \
    initialize_app as flask_raw_example_initialize_app
from lsst_ts.bokeh.apps.examples.flask_react_simple.export import \
