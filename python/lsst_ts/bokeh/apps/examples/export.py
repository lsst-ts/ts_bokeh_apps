...
examples_html = """<!doctype html>
                    ...
                    <body>
                      <div>
                        <a  target="_blank" href="http://localhost:5006/examples/bokeh_raw_example"> Bokeh Raw Example</a><br/>
                        <a  target="_blank" href="http://localhost:5006/examples/bokeh_static_example"> Bokeh Static Example</a><br/>
                        <a  target="_blank" href="http://localhost:8000/examples/examples_menu">Flask Raw Example</a><br/>
                        <a  target="_blank" href="http://localhost:8000/examples/flask_embedding_bokeh_example">Flask Embedding Bokeh Example</a><br/>
                        <a  target="_blank" href="http://localhost:8000/examples/flask_bokeh_full">Flask Bokeh Full Example</a><br/>
                        <a  target="_blank" href="http://localhost:8000/examples/flask_react_simple">Flask React Simple Example</a><br/>
                      </div>
                    </body>
                    </html>"""
