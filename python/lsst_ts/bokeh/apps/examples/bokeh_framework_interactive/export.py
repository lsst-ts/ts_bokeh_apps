...
from lsst_ts.bokeh.apps.examples.bokeh_framework_interactive.interactive_example_layout import InteractiveExampleLayout
...
def initialize_app(server_information: ServerInformation) -> ServerInformation:
    ...
    server_information.add_application("/examples/bokeh_framework_interactive", create_application)
