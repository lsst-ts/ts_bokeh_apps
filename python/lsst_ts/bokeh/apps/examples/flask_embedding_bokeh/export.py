...
def initialize_app(server_information: ServerInformation):
    flask_embedding_example_blueprint = Blueprint('flask_embedding_example_blueprint',
                                                  ...
                                                  static_url_path='/examples/flask_embedding_bokeh_example/static')

    @flask_embedding_example_blueprint.route("/", methods=['GET'])
    def plot_selector():
    ...
    @flask_embedding_example_blueprint.route("/<variable_to_plot>", methods=['GET'])
