...
def generate_examples_page(bokeh_host: str, bokeh_port: int):
    return f"""<!doctype html>
                    ...
                    <body>
                      <div>
                        <a  target="_blank" href="http://{bokeh_host}/examples/bokeh_raw"> Bokeh Basic Example</a><br/>
                        <a  target="_blank" href="http://{bokeh_port}/examples/bokeh_static"> Bokeh Static Example</a><br/>
                      </div>
                    </body>
                    </html>"""
