...
class ExceptionInformationWidget:
    ...
    def create(self) -> List[Widget]:
        ...
        self._relation_div = Div(text=ExceptionInformationWidget._relation_factory[self._child_relation], styles={"color": "red"})
...
class LogViewer:
    ...
    def create(self) -> LayoutDOM:
        ...
        :return: LayoutDOM
        """
        self._no_information_label = Div(name = "no_information_lbl", text = "PLEASE SELECT A CORRECT <BR/> SALINDEX TO SHOW INFORMATION", styles={'text-align': 'center', 'width': '100%'})
