...
from lsst_ts.bokeh.utils.bokeh_framework.data_aggregator import (
    DataAggregator, VoidDataAggregator)
...
class Layout(ABC):
    def __init__(
        self,
        interaction: Interaction = VoidInteraction(),
        data_aggregator: DataAggregator = VoidDataAggregator(),
    ) -> None:
        super().__init__()
